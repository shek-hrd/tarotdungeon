...
class MultiplayerManager {
    ...
    simulateConnection() {
        ...
        if (typeof narrator !== "undefined" && narrator.welcomePlayer) narrator.welcomePlayer(this.playerName);
    }
    ...
    addSimulatedPlayer(name) {
        ...
        if (typeof narrator !== "undefined" && narrator.playerJoined) narrator.playerJoined(name);
        this.updatePlayerList();
    }
    ...
    updatePlayerList() {
        ...
        const container = document.getElementById('playerList'); if (container) container.style.display = 'block';
    }
    ...
    disconnect() {
        this.connected = false;
        if (typeof narrator !== "undefined" && narrator.playerLeft) narrator.playerLeft(this.playerName);
    }
