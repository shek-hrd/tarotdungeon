...
class TarotDungeonGame {
    ...
    startGame() {
        ...
        document.getElementById('tarotDisplay').style.display = 'block';
    ...
    openDoor(doorId) {
        ...
        if (newRoom) {
            ...
            if (door && door.card) {
                document.getElementById('cardImage').textContent = door.card.image;
                document.getElementById('cardName').textContent = door.card.name;
                document.getElementById('cardMeaning').textContent = door.card.meaning;
